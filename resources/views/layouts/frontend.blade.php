...
<html lang="en">
    <head>
        <title>{{ $title ?? 'Autenthic' }}</title>
        <!-- Required meta tags -->
        <!-- CSRF Token -->
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta content="Toko Autenthic menjual berbagai jenis tas" name="description">
        <meta content="{{ $title ?? 'Autenthic' }}" name="keywords">
        <meta property="og:locale" content="ID_id"/>
        <meta property="og:type" content="website"/>
        <meta property="og:image" content="{{ asset('assets/img/yas2.jpg') }}">
        <!-- Bootstrap CSS -->
        <link rel="shortcut icon" href="{{ asset('assets/img/tas2.jpg') }}">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><b>Autenthic</b></a>
        ...
        <div class="copyright">
            <div class="container text-center">
                Copyright &copy; <?= date('Y');?>  All Reserved
                <br>
                Autenthic
            </div>
        </div>
